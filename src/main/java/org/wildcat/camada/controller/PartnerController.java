...
public class PartnerController extends BaseController<Partner, PartnerDTO> {
    ...
    void initTable() {
        ...
        AppTableColumn<PartnerDTO> firstNameColumn = new AppTableColumn<>(surnames, "surnames", new TextValidatorImpl(3, 20), CustomTableColumn.PARTNER_SURNAMES);
        tableCommonService.initTextFieldTableCell(firstNameColumn, table, progressIndicator);
        AppTableColumn<PartnerDTO> dniColumn = new AppTableColumn<>(dni, "dni", new TextValidatorImpl(3, 20), CustomTableColumn.PARTNER_DNI);
        tableCommonService.initTextFieldTableCell(dniColumn, table, progressIndicator);
        AppTableColumn<PartnerDTO> addressColumn = new AppTableColumn<>(address, "address", new TextValidatorImpl(3, 20), CustomTableColumn.PARTNER_ADDRESS);
        tableCommonService.initTextFieldTableCell(addressColumn, table, progressIndicator);
        AppTableColumn<PartnerDTO> postCodeColumn = new AppTableColumn<>(postCode, "postCode", new TextValidatorImpl(3, 20), CustomTableColumn.PARTNER_POST_CODE);
        ...
        AppTableColumn<PartnerDTO> ibanColumn = new AppTableColumn<>(iban, "iban", new TextValidatorImpl(3, 20), CustomTableColumn.PARTNER_IBAN);
